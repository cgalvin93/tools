...
#time ipython ~/tools/fd_pps.py 3dk9_fdnoh.sc ~/filt/nat/native_seqs/3dk9_binding_site.txt fdnoh33dk9.pdf 3dk9

#time ipython ~/desktop/tools/pps.py cmnoh1f4p.sc ~/desktop/prj/filter_comparison/native_seqs/1f4p_binding_site.txt cmnoh1f4p.pdf 1f4p
#time ipython ~/tools/cm_pps.py cmnoh1f4p.sc ~/filt/nat/native_seqs/1f4p_binding_site.txt cmnoh1f4p.pdf 1f4p
...
'''
amandas_path=r'/wynton/home/kortemme/cgalvin/filt/genpot/cm/pdb/'+ptn_pdb_id
...
nstrc=[len(seqs),len(amandas_strc_2)]

#make a file with all pps scores so I can make plot for all easily
import json
outdict={}
all_pps_path=r'/wynton/home/kortemme/cgalvin/genpot/strc/am1bcc/cmallpps.json'
allfile=open(all_pps_path,'a')
outdict[sys.argv[4]+'_'+sys.argv[1][:-3]]=pps_scores
outdict[sys.argv[4]+'_amanda']=pps_amanda
json.dump(outdict,allfile)
allfile.write('\n')
allfile.close()
